...
const App: FC = () => {
  return (
    <BrowserRouter>
      <div className="min-h-screen flex relative flex-col overflow-hidden">
        {/* Arkaplan */}
        <div className="fixed inset-0 bg-linear-to-br from-dark-bg via-black-100 to-dark-bg -z-10"></div>
